...
export const User = ({id, email, avatar, first_name, last_name,isInvited, handleInvite}) => (
  <li>
    <div>
    ...
    <img className="action" src={`/assets/${isInvited ? 'minus' : 'plus'}.svg`} alt="Action" onClick={()=>handleInvite(id)} />
  </li>
);
